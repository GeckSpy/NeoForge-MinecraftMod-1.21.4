...
public class TntV3Block extends TntBlock {

    public TntV3Block(Properties properties) {
        super(properties);
    }
    ...
    public void onCaughtFire(BlockState state, Level level, BlockPos pos, @Nullable Direction face, @Nullable LivingEntity igniter) {
        if (!level.isClientSide) {
            PrimedTntV3 primedTnt = new PrimedTntV3(level, pos.getX() + 0.5, pos.getY(), pos.getZ() + 0.5, igniter);
