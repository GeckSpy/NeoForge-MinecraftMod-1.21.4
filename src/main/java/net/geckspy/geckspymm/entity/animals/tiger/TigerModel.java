package net.geckspy.geckspymm.entity.animals.tiger;
...
public class TigerModel extends EntityModel<TigerRenderState>  {
    ...
    public void setupAnim(TigerRenderState state) {
        ...
        animateWalk(TigerAnimations.WALK, state.walkAnimationPos, state.walkAnimationSpeed, 2f, 2.5f);
        this.animate(state.idleAnimationState, TigerAnimations.IDLE, state.ageInTicks, 1f );
    }
}
