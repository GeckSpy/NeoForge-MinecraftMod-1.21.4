...
public class PrimedTntV3Renderer extends EntityRenderer<PrimedTntV3, TntRenderState> {
    private final BlockRenderDispatcher blockRenderer;

    public PrimedTntV3Renderer(EntityRendererProvider.Context context){
        super(context);
    ...
    public void render(TntRenderState renderState, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight) {
        ...
        if (fuse / 32 % 2 == 0) { // Every other tick when fuse < 40
            ...
            blockRenderer.renderSingleBlock(ModBlocks.TNT_V3.get().defaultBlockState(), poseStack,
